...
object MaterialUi {
  ...
  implicit class MaterialUiVirtualDOMAttributes(attributes: VirtualDOMAttributes) {
    ...
    lazy val autoScrollBodyContent = BooleanAttributeSpec("autoScrollBodyContent")
    ...
    lazy val containerElement = ElementAttributeSpec("containerElement")
    ...
    lazy val buttonIcon = ElementAttributeSpec("icon")
