...
object MaterialUiIcons {
  ...
  val questionsConfigurationSvgPath =
  ...
  val operationIcon: ReactElement =
    <.SvgIcon()(reactjs.React.createElement("path", js.Dictionary("d" -> operationSvgPath)))

  val questionIcon: ReactElement =
    <.SvgIcon()(reactjs.React.createElement("path", js.Dictionary("d" -> questionSvgPath)))

  val organisationIcon: ReactElement =
    <.SvgIcon()(reactjs.React.createElement("path", js.Dictionary("d" -> organisationSvgPath)))

  val moderatorIcon: ReactElement =
    <.SvgIcon()(reactjs.React.createElement("path", js.Dictionary("d" -> moderatorSvgPath)))

  val homepageIcon: ReactElement =
    <.SvgIcon()(reactjs.React.createElement("path", js.Dictionary("d" -> homepageSvgPath)))

  val questionsConfigurationIcon: ReactElement =
    <.SvgIcon()(reactjs.React.createElement("path", js.Dictionary("d" -> questionsConfigurationSvgPath)))
